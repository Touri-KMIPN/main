...
import { AlignJustifyIcon, MapIcon, XIcon } from "lucide-react";
              ...
              <div className="flex flex-1 overflow-hidden">
                <div
                  className={cn(
                    ...
                    mapOpen ? "w-full md:w-2/5" : "w-full"
                  )}
                >
                  {children}
                </div>
                ...
                {!mapOpen && (
                  <Button
                    ...
                    size="icon"
                    variant="outline"
                    className="hidden md:flex fixed top-5 right-5 z-10 h-12 w-12 rounded-full cursor-pointer shadow-lg hover:shadow-xl transition-all"
                  >
                ...
                {/* Mobile Nav */}
                <div className="w-full md:hidden bg-sidebar flex py-2 px-4 justify-between border-b absolute inset-x-0 top-0">
                  <Button
